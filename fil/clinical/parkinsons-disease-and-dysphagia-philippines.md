...
license: "CC BY 4.0"
canonical: "https://softmeal.org/fil/clinical/parkinsons-disease-and-dysphagia-philippines.html"
---
...
- **Chewing** — moving the jaw side-to-side
- **Tongue movement** — pushing food to the back of the throat
- **Throat muscles** — squeezing food down the esophagus
- **Airway protection** — closing the vocal cords to prevent food from entering the lungs
...
- Sudden onset of severe choking or inability to swallow
- Fever + cough after eating (possible aspiration pneumonia)
- Rapid weight loss (>5% in 1 month)
- Refusing to eat for >3 days due to fear of choking
...
- Use an EMST150 or similar device (not widely available in Philippines; may need to order online)
- Perform breathing exercises 5 days per week, 2 sets of 5 repetitions
- Typical duration: 8–16 weeks
- Benefits: Improved cough strength, reduced aspiration risk, better airway protection
...
- Regular Filipino foods that are naturally soft or can be cooked soft
- Examples: Tinola (chicken soup, soft chicken), lugaw (rice porridge), adobo with tender meat, sinigang (soup with soft vegetables)
- Can include most Filipino dishes if cooked until meat is very tender

**IDDSI Level 5 (Minced & Moist) — For Moderate PD:**
- Food finely chopped/minced into pieces ≤4mm wide, ≤15mm long
- Must be moist (coated in sauce, not dry)
- Examples: 
  - Minced adobo (finely ground pork in sauce)
  - Sinigang with finely minced meat
  - Tinirang bagnet (fried meat, minced finely and moistened with sauce)
  - Lugaw with egg and minced chicken
  - Nilaga (soup) with minced meat and very soft vegetables

**IDDSI Level 4 (Pureed) — For Advanced PD:**
- Smooth pureed texture; no lumps
- Can be shaped/molded
- Examples:
  - Pureed adobo (blended pork)
  - Smooth lentil soup
  - Pureed tinola
  - Egg yolk with chicken broth (soft custard-like)
  - Pureed sweet potato or squash

**IDDSI Level 3 (Liquidised/Moderately Thick) — For Severe Dysphagia:**
- Can be drunk from cup; no pieces visible
- Thick enough that a spoon moves slowly through it
- Examples: Thick rice porridge, blended soup, thickened fruit juice, thick commercial nutritional drinks
...
**Why?** 
- Protein in food competes with levodopa for absorption
- If you take levodopa during a meal, less medication reaches the brain
- Less dopamine in the brain = worse swallowing ability during that meal

**Example schedule:**
- 8:00 AM: Take levodopa + water (no food)
- 8:45 AM: Eat breakfast
- 12:00 PM: Take midday levodopa + water
- 12:45 PM: Eat lunch
- 4:00 PM: Afternoon levodopa
- 5:00 PM: Early dinner (before evening dose wears off)
...
**Warning signs:**
- Fever (>38°C / 100.4°F) that appears 1–3 hours after coughing during a meal
- Cough with yellow/green phlegm
- Shortness of breath
- Confusion or change in mental status (in elderly)
...
- Ensure Gold, Ensure Plus (pharmacy chains: Mercury Drug, Watsons)
- Sustagen (local brand)
- Boost
- Cost: ₱150–350 per can (different brands/sizes)
...
- Formal swallowing evaluation (VFSS or FEES if available at tertiary hospitals)
- Customized exercise plan
- Dietary recommendations
- Ongoing support

**If you don't have access:**
- Ask your neurologist for a referral (some private hospitals in regional cities have SLPs)
- Use home-based methods in this guide (Mendelsohn maneuver, texture modification)
- Monitor closely for aspiration pneumonia warning signs
- Contact SLPs via telemedicine (some Metro Manila clinics offer phone/video consultations)

**Major hospitals in Philippines with speech therapy services:**
- Philippine General Hospital (PGH) — Manila
- The Medical City — Pasig
- St. Luke's Medical Center — Quezon City, BGC
...
A: When:
- Weight loss exceeds 10% despite dietary modification
- Patient is aspirating even thin liquids (Level 0)
- Meal times exceed 2 hours (exhausting for caregiver + patient)
- Recurrent aspiration pneumonia (>2 episodes per year)
...
- [The prevalence and associated factors of dysphagia in Parkinson's disease: A systematic review and meta-analysis](https://www.frontiersin.org/journals/neurology/articles/10.3389/fneur.2022.1000527/full) — Frontiers in Neurology, 2022. Global prevalence 36.9%, Asia 38.6%, risk factors.
- [Variations in Incidence and Prevalence of Parkinson's Disease in Taiwan: A Population-Based Nationwide Study](https://pmc.ncbi.nlm.nih.gov/articles/PMC4745820/) — PMC, 2016. Taiwan PD epidemiology.
- [Aspiration and swallowing in Parkinson disease and rehabilitation with EMST: a randomized trial](https://pubmed.ncbi.nlm.nih.gov/21098406/) — Troche et al. 2010. EMST Class I evidence.
- [Consensus on the treatment of dysphagia in Parkinson's disease](https://www.jns-journal.com/article/S0022-510X(21)02704-0/fulltext) — Journal of the Neurological Sciences, 2021.
- [A comprehensive review of the diagnosis and treatment of Parkinson's disease dysphagia and aspiration](https://pmc.ncbi.nlm.nih.gov/articles/PMC10405619/) — PMC, 2023. Management review.
- [Rehabilitation interventions for oropharyngeal dysphagia in people with Parkinson's disease](https://pmc.ncbi.nlm.nih.gov/articles/PMC10811748/) — PMC, 2024. Recent rehab review.
- [Filipinos and Parkinson's disease: A scoping review of the literature](https://www.sciencedirect.com/science/article/abs/pii/S1353802025000124) — ScienceDirect, 2025. Philippine-specific context.
- Yoneyama T, et al. (2002). Oral care and the development of aspiration pneumonia in older adults — PMID 11943036. [citation: landmark RCT on oral hygiene preventing pneumonia]
...
**Last updated:** 2026-05-19 · **License:** [CC BY 4.0](../../LICENSE) · **Maintained by [SeniorDeli (Carewells)](https://www.seniordeli.com)** — a Hong Kong social enterprise producing IDDSI-compliant care food. This page is educational only; see [About](/about) for our clinical partners and social mission.

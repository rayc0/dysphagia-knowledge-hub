---
title: "IDDSI Level 2 (Mildly Thick): Flow Test, Clinical Indications, Thickener Selection, and Caregiver Guidance"
description: "Complete guide to IDDSI Level 2 Mildly Thick liquids — syringe flow test values, who benefits, thickener types, common errors, and HK clinical food examples."
lang: en
category: iddsi
date: 2026-05-09
...
- Water, fruit juices, cordials, tea, coffee — all require thickener added to specified dose
- Milk (both dairy and plant-based) — requires thickener; note that milk proteins interact with some thickener formulations
- Warm soups (clear broth, miso-type) — strained only, no solids; require thickening
- Oral nutritional supplement drinks — may reach Level 2 at standard concentration with added thickener, or check manufacturer IDDSI certification

**Items that do not belong at Level 2 without testing:**
- Smoothies and blended fruit drinks — viscosity varies enormously by ingredient and blending time; must be syringe-tested per batch
- Commercial "nectar" drinks — unless IDDSI-certified Level 2, the old nectar designation is not equivalent
- Coconut milk drinks — high natural viscosity but inconsistent; test each batch

**Items not appropriate at any liquid level:**
- Any drink with particulates, pulp, or suspended solids — these create mixed-texture risk even in thickened form
- Carbonated drinks — carbonation affects viscosity measurement and is not recommended with most thickeners
...
- Chrysanthemum tea — popular with elderly in Hong Kong; thickened for patients in residential care
- Warm barley water — already slightly viscous naturally; requires syringe test before assuming compliance
- Thickened red bean soup — only if fully strained with no solids; texture of any suspended solids would disqualify it from being a pure liquid prescription
- Thickened soy milk at Level 2 dose — commonly used in elderly care centres in HK

**International examples:**
- Thickened Ensure or Fortisip at Level 2 dose — widely used in hospital and nursing home settings
- Thickened apple, grape, or cranberry juice — common in North American and Australian residential care
- Thickened oral rehydration solutions — used in paediatric dysphagia management

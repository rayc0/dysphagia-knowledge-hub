---
title: "IDDSI Level 4 (Pureed): Clinical Guide to Food Testing, Preparation Standards, and Patient Management"
description: "Complete guide to IDDSI Level 4 Pureed diet — fork drip test, spoon tilt test, allowed foods, caregiver preparation errors, and HK clinical food examples."
lang: en
category: iddsi
date: 2026-05-09
...
# IDDSI Level 4 (Pureed): Clinical Guide to Food Testing, Preparation Standards, and Patient Management
...
**Proteins:**
- Blended congee with strained meat (meat fully processed, no fibrous strands)
- Smooth tofu blended with broth
- Blended egg — scrambled eggs processed to uniform smoothness
- Fish puree (boneless white fish blended with milk or broth)
- Blended steamed minced pork or chicken with sufficient added liquid

**Vegetables:**
- Blended pumpkin or sweet potato puree (no skin or fibrous threads)
- Blended cooked carrot or zucchini
- Blended spinach (strained to remove fibrous stems)
- Smooth blended pea puree (strained)

**Grains and starches:**
- Smooth rice congee thinned to Level 4 consistency
- Mashed sweet potato blended to uniform smoothness
- Smooth mashed taro with added liquid

**Desserts and sweet items:**
- Smooth blended mango or papaya puree
- Smooth silken tofu dessert — usually tests close to Level 3/4 boundary; verify
- Blended red bean paste (without skins) — smooth with skins fully strained

### Excluded — foods that cannot reliably achieve Level 4:

- Any blended food with residual fibrous strands — tough meats, celery, leeks
- Blended vegetables with skins that have not been strained — peas, beans
- Mixed-texture preparations — foods where liquid separates from solid component
- Foods with seeds, husks, or shells regardless of blending
- Standard yoghurt with fruit pieces — the pieces create texture irregularity
- Blended food that has been refrigerated and becomes too thick — re-test after chilling
...
- Congee-base puree: smooth white congee blended with steamed fish or minced pork, strained — widely used in Hong Kong elderly care
- Steamed egg custard: when prepared with sufficient water ratio and steamed at low heat to avoid holes — close to Level 4 boundary; test required
- Taro puree: common dessert and meal component in Cantonese cuisine; requires high-speed blending and straining
- Pumpkin puree: widely used in HK care homes, simple to prepare, naturally cohesive
- Smooth red bean soup with all skins strained — a common hospital diet component in HK

**International examples:**
- Smooth hummus blended to Level 4 consistency (tahini and chickpeas fully processed, no grains)
- Smooth avocado puree without chunks
- Smooth mashed potato (without skin or lumps) with sufficient added milk or butter
- Smooth blended yoghurt with no fruit pieces — plain varieties; Greek yoghurt may require thinning

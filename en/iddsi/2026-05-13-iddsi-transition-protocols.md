---
layout: post
title: "IDDSI Transition Protocols: Evidence-Based Criteria for Progressing Between Diet Levels"
description: "Evidence for IDDSI diet progression criteria, SLT-guided trial methodology, home trial checklists, documentation standards, and regression warning signs for dysphagia patients."
lang: en
category: iddsi
date: 2026-05-13
...
# IDDSI Transition Protocols: Evidence-Based Criteria for Progressing Between Diet Levels
...
## Why Transition Decisions Are Complex
...
## Evidence for Progression Criteria
...
## SLT-Guided Clinical Trial Methodology
...
- Food and drink served (IDDSI level confirmed)
- Meal duration (in minutes)
- Observed episodes of coughing or throat-clearing (number and timing — during or after swallowing)
- Voice quality after eating: dry and clear / slightly wet / noticeably wet or gurgling
- Patient reported comfort: 1 = comfortable, 2 = slight effort, 3 = noticeable difficulty
- Any vomiting, regurgitation, or refusal
- Carer signature and date
...
- The date of the clinical or instrumental assessment informing the transition
- The previous IDDSI level (food and fluid, stated separately)
- The new prescribed level (food and fluid, stated separately)
- The clinical basis for the decision (bedside assessment findings, instrumental results if performed, or trial meal observations)
- Any compensatory strategies that continue to apply at the new level
- The SLT's name and designation
...
- Choking episode requiring back blows or abdominal thrusts
- Loss of consciousness or respiratory distress during or after a meal
- Blue lips or oxygen saturation drop during feeding

**Urgent review within 24–48 hours:**
- New consistent coughing on every meal at the current level, when previously cough-free
- Persistent wet or gurgling voice after eating
- Complete meal refusal for two or more consecutive meals
- New diagnosis of aspiration pneumonia on chest X-ray

**Scheduled review (within one week):**
- Gradual increase in coughing frequency over three to four days
- Emerging fatigue during meals that was not previously present
- Significant unplanned weight loss (more than 2 kg in two weeks)
- New neurological event (TIA, falls, deteriorating cognition)
- Any hospitalisation — diet prescription should be re-established from scratch on return to the RCHE or home, not assumed to be unchanged

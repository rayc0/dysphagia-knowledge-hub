...
**Kubota Grading**:
- Grade 1: Drank 50 mL in single swallow, no cough, <5 seconds — Normal
- Grade 2: Drank in 2+ swallows or >5 seconds, no cough — Mild
- Grade 3: Drank in single swallow with cough — Moderate
- Grade 4: Drank in 2+ swallows with cough — Severe
- Grade 5: Unable to drink entire 50 mL, frequent choking — Very severe
...
**Sensitivity**: ~70–80% for aspiration on VFSS (Suiter & Leder, 2008; DOI: 10.1007/s00455-007-9127-y)
**Specificity**: ~59–70%
...
- Patients with reduced laryngeal sensation (post-stroke, post-radiotherapy)
- Patients with impaired cough reflex (Parkinson's, advanced dementia)
- Elderly patients generally
...
- Use WST as a first-line screen in acute stroke (within 4 hours of admission, before oral intake).
- Combine WST with EAT-10 to improve specificity.
- A positive WST → refer to SLT for clinical swallowing examination (CSE) before initiating oral diet.
- A negative WST in high-risk populations (Parkinson's, advanced dementia) → still proceed to CSE due to silent aspiration risk.
- Document all findings including patient position, water temperature, and volume consumed.

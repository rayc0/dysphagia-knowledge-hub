---
title: "Mendelsohn Maneuver — Complete Clinical Guide for SLPs, Patients, and Caregivers"
description: "Step-by-step clinical guide to the Mendelsohn maneuver: physiology, candidate selection, dosing, biofeedback options (sEMG, ultrasound), evidence base, and integration with other dysphagia rehabilitation techniques."
lang: en
category: clinical
date: 2026-05-20
...
1. **Suprahyoid muscles** (mylohyoid, geniohyoid, anterior belly of digastric, stylohyoid) — these elevate and anteriorly displace the hyoid.
2. **Thyrohyoid muscle** — bridges the hyoid to the thyroid cartilage, transmitting hyoid movement to the larynx.
3. **Pharyngeal constrictors** — work synchronously with hyolaryngeal excursion to clear the bolus.
...
What the evidence does **not** strongly support is the use of the Mendelsohn maneuver as a stand-alone treatment. Best outcomes are reported when it is one component of a multimodal program — combined as appropriate with the [Shaker exercise or CTAR](shaker-exercise-vs-ctar-dysphagia-suprahyoid-strengthening), [tongue-hold (Masako) maneuver](2026-05-09-tongue-hold-masako-maneuver), [expiratory muscle strength training](expiratory-muscle-strength-training-emst-dysphagia), and [NMES protocols](neuromuscular-electrical-stimulation-nmes-vitalstim-dysphagia) where indicated.

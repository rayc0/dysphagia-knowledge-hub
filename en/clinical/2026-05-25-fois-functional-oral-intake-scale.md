...
- **Level 3**: Tube supplemented with consistent oral intake of food or liquid
...
- **Inter-rater reliability**: κ = 0.86 (excellent)
- **Intra-rater reliability**: κ = 0.91
- **Concurrent validity**: Significant correlation with Penetration-Aspiration Scale (r = −0.60) and VFSS-based diet recommendations
- **Responsiveness**: Significant FOIS improvement from admission to discharge in rehabilitation cohorts (mean change ~1.5 levels)

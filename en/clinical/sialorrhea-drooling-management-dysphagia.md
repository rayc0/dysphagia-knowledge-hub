---
title: "Sialorrhea and Drooling in Dysphagia — A Clinical and Caregiver Management Guide"
description: "Evidence-based guide to managing sialorrhea (excessive saliva and drooling) in patients with dysphagia: why it happens in Parkinson's, stroke, ALS and dementia, how to assess it, and a stepwise approach from posture and behavioural therapy to anticholinergics, botulinum toxin, and surgery — with caregiver protocols and aspiration-prevention strategies."
lang: en
category: clinical
date: 2026-05-20
author: Susan Tam
...
1. **Optimise position at all times, not just at meals.** Keep the trunk upright and the head in a neutral or slightly chin-down position when awake. Avoid prolonged flat or head-back positioning, which directs secretions toward the airway.
2. **Protect the airway during sleep.** Where clinically advised, slight head-of-bed elevation and side-lying can reduce nocturnal pooling and aspiration. Discuss this with the clinical team for each individual.
3. **Skin care.** Saliva is enzymatically irritating. Pat (do not rub) the perioral area dry, apply a barrier cream, and inspect for breakdown daily.
4. **Oral hygiene twice daily.** This is non-negotiable. A clean mouth lowers the bacterial load of any aspirated secretions and is one of the most evidence-based interventions for reducing aspiration pneumonia.
5. **Cue swallowing.** Build regular gentle reminders to swallow into the daily routine, particularly during activities that demand concentration (the period when patients drool most).
6. **Watch for the danger signs.** Wet or gurgly voice, increased respiratory secretions, low-grade fever, breathlessness, or new confusion may signal aspiration pneumonia. These warrant prompt clinical review — secretion aspiration kills, and early treatment saves lives.
7. **Manage hydration carefully.** Aim for thin-enough, well-cleared secretions through adequate (texture-modified) fluid intake, while avoiding over-drying from excessive anticholinergic dosing.
...
- [Sialorrhea in Parkinson's Disease — PMC/NIH](https://pmc.ncbi.nlm.nih.gov/articles/PMC7692771/)
- [Pharmacological Interventions for Sialorrhoea in Parkinson's Disease: Systematic Review and Meta-Analysis — PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10105093/)
- [Management of Sialorrhea in ALS — Palliative Care Network of Wisconsin](https://www.mypcnow.org/fast-fact/management-of-sialorrhea-in-als/)
- [Treatment for sialorrhea in motor neurone disease/ALS — PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC9121913/)
- [Efficacy of Botulinum Toxin for Treating Sialorrhea in Neuromuscular Conditions — Frontiers in Neurology](https://www.frontiersin.org/journals/neurology/articles/10.3389/fneur.2020.00513/full)
- [The Role of Speech Therapy in Sialorrhea Management and Quality of Life — PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC11851127/)
- [Hypersalivation/Ptyalism/Sialorrhea — Iowa Head and Neck Protocols, University of Iowa](https://iowaprotocols.medicine.uiowa.edu/protocols/hypersalivationptyalismsialorrhea)
- [Sialorrhea: A Management Challenge — American Family Physician (AAFP)](https://www.aafp.org/pubs/afp/issues/2004/0601/p2628.html)

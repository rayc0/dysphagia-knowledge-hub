...
license: "CC BY 4.0"
canonical: "https://softmeal.org/en/clinical/2026-05-13-passy-muir-valve-dysphagia"
---
...
1. Ensure full cuff deflation and confirm by audible airflow around the tube or manometry
2. Apply PMV; monitor SpO2, respiratory rate, and work of breathing continuously
3. Begin with 5–10 minutes of rest breathing with PMV; extend incrementally if tolerated
4. Once tolerance at rest is established, progress to phonation tasks
5. Progress to swallowing trials under SLT supervision, using FEES where available
6. Document tolerance time, SpO2 nadir, cough strength, phonation quality, and swallowing observations
7. If tolerated, increase wear time across subsequent sessions toward continuous daytime use

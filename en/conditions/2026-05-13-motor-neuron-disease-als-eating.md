...
license: "CC BY 4.0"
canonical: "https://softmeal.org/en/conditions/motor-neuron-disease-als-eating.html"
---
...
- **Prolonged mealtimes**: Meals taking noticeably longer than previously, without an obvious cause
- **Increased effort chewing** soft foods that previously required no effort
- **Occasional coughing with liquids**, particularly at the end of a sip
- **Difficulty with crumbly foods** (biscuits, crackers, bread crusts) that fragment and scatter in the mouth
- **Voice change post-meal**: A wet or gurgly voice quality after eating or drinking (indicating pharyngeal residue)
- **Fatigue during meals**: Feeling "worn out" by eating in a way not previously experienced
...
- **PEG is not the end of eating**: Where aspiration risk allows, patients may continue to eat for pleasure (comfort feeding) alongside PEG nutritional supplementation. Many patients and families do not realise this — they assume PEG means no more eating. The distinction should be explicitly communicated.
- **PEG is not a commitment to maximal life prolongation**: Having a PEG tube placed is compatible with advance directives that limit other invasive interventions. PEG and palliative care goals are not mutually exclusive.
- **PEG is not appropriate for all patients**: Patients who have made an informed decision against invasive interventions, or whose ALS progression trajectory makes the procedural burden disproportionate, may choose not to pursue PEG. This is a valid choice that the multidisciplinary team should support with enhanced comfort care.
...
- **Anticholinergic medications**: Hyoscine patches (Scopoderm), amitriptyline (low dose), glycopyrronium bromide — all reduce saliva production. Available through neurology clinic prescription in HK.
- **Botulinum toxin injection** into the parotid or submandibular salivary glands: Reduces saliva volume for 3–4 months per injection. Available at specialist neurology centres (Queen Mary Hospital neuromuscular clinic, Prince of Wales Hospital).
- **Oral suction**: Portable bedside suction for home use to remove pooled secretions.
- **Positioning**: Head slightly forward (not backward) reduces drainage toward the larynx.
...
- **Hospital Authority palliative care units**: Based at Pamela Youde Nethersole Eastern Hospital, Haven of Hope Hospital, Grantham Hospital, and others with inpatient, day hospice, and community components
- **HA community palliative care teams**: Provide home visits and telephone support for patients managed at home
- **HK MND Association (香港運動神經元病協會)**: Provides peer support, caregiver guidance, and links to HA neurology services. An important first contact point for families newly navigating ALS services.
...
- Non-invasive ventilation (NIV/BiPAP) — does the patient want this when respiratory failure develops?
- Invasive ventilation — tracheostomy ventilation that prolongs life but does not alter disease course
- Artificial nutrition — PEG versus no PEG
...
*For the full clinical trajectory of dysphagia in ALS, see [Dysphagia in ALS/MND: Progressive Management from Early to Late Stage](/en/conditions/als-motor-neurone-disease-dysphagia.html). For advance care planning tools in Hong Kong, see [Advance Care Planning for Dysphagia Patients in HK](/en/conditions/advance-care-planning-hk-dysphagia.html).*

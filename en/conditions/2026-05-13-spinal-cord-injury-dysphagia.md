...
license: "CC BY 4.0"
canonical: "https://softmeal.org/en/conditions/spinal-cord-injury-dysphagia.html"
---
...
- Retraction of the oesophagus and pharynx during surgical access
- Post-surgical oedema compressing pharyngeal structures
- Anterior cervical plate hardware that can compress or tether the oesophagus
- Prevertebral soft tissue swelling visible on lateral cervical X-ray
...
### Mechanisms of tracheostomy-related dysphagia
...
- As surgical oedema resolves and tracheostomy weaning proceeds, IDDSI level can often be progressed within weeks to months
- Regular re-assessment (minimum every 2–4 weeks during active rehabilitation) allows IDDSI level to be updated rather than remaining static
- The goal is return to a normal or near-normal diet and unmodified fluids where neurological and anatomical recovery permits
...
- **Tuen Mun Hospital**: Primary inpatient SCI rehabilitation
- **Kowloon Hospital**: Inpatient rehabilitation
- **Grantham Hospital**: Rehabilitation including brain injury and SCI
- **Castle Peak Hospital** / **Pok Oi Hospital**: Community rehabilitation support
...
*For tracheostomy management at home, see [Tracheostomy and Dysphagia: A Caregiver Guide](/en/caregiving/tracheostomy-dysphagia-caregiver-guide.html). For IDDSI texture testing at home, see [How to Test Food and Drink Consistency at Home Using IDDSI Methods](/en/caregiving/iddsi-home-testing-guide.html).*

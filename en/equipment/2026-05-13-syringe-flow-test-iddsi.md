---
layout: post
title: "The IDDSI Syringe Flow Test: Equipment, Method, and Reading Results"
description: "Step-by-step guide to the IDDSI syringe flow test for classifying thickened drinks at Levels 0–4: equipment needed, measurement method, common mistakes, and when to use it at home versus clinical settings."
lang: en
category: equipment
date: 2026-05-13
...
- **10 ml plain-tip syringe** (Luer Slip, without needle) — specifically a BD 10 ml syringe or equivalent; volume markings must be clearly visible
- A **timer accurate to one second** (a smartphone timer works well)
- The **liquid to be tested** at the temperature it will be served
- A **clean container** to catch the flowing liquid

Do not use:
- Syringes larger or smaller than 10 ml — the barrel diameter changes the flow rate and invalidates the result
- Syringes with a Luer Lock tip — the internal channel diameter differs
- Syringes with a needle attached — too narrow
...
- Verify batch-prepared thickened beverages before serving
- Train kitchen staff in correct thickener preparation
- Document that the prescribed IDDSI fluid level was actually achieved
- Audit compliance at spot checks

**At home**, the flow test is most useful when:
- The carer is first learning to prepare thickened drinks and wants to confirm the result before the patient drinks
- The patient's SLT has specified a precise level that requires verification (e.g., Level 1 for post-extubation patients where over-thickening is as harmful as under-thickening)
- A new brand of thickener is being trialled and the dose-to-level relationship is not yet established for that household's preferred beverages

---
layout: post
title: "FEES: Fibreoptic Endoscopic Evaluation of Swallowing Explained"
description: "What FEES is, how it differs from VFSS, what the camera sees during a swallow, patient experience, clinical indications, and availability in Hong Kong hospitals."
lang: en
category: equipment
date: 2026-05-13
...
- **No radiation exposure** — safe for pregnant women, young children, and patients requiring frequent reassessment
- **Portable** — the endoscope can be brought to the bedside, ICU, ward, or residential care home (RCHE), making it accessible to patients who cannot be transported to radiology
- **Sensory testing** — FEES with sensory testing (FEESST) delivers calibrated air pulses to the laryngeal mucosa to assess laryngopharyngeal sensation, which VFSS cannot assess
- **Direct mucosal view** — secretion pooling, mucosal lesions, and vocal fold movement are visible directly
- **Real food and liquid** — no barium is required; actual food and fluids of any IDDSI level can be tested
...
- **Pre-swallow pooling**: food or liquid that accumulates in the valleculae (the space behind the tongue base) or pyriform sinuses before the swallow is triggered — a sign of delayed or absent swallow initiation
- **Penetration**: food or liquid entering the laryngeal vestibule but not passing below the vocal folds
- **Aspiration**: material passing below the vocal folds into the trachea
- **Silent aspiration**: aspiration without cough or throat-clearing — a particularly important finding in stroke and neurodegenerative disease
- **Post-swallow residue**: food remaining in the pharynx after the swallow has completed, which may fall into the airway on the next breath
- **Vocal fold function**: reduced abduction or adduction may explain breathy voice or aspiration
...
- The patient is bedbound, in ICU, or cannot be safely transported to a radiology suite
- Radiation exposure is contraindicated or undesirable
- The referring team wants direct assessment of secretion management and laryngeal sensation
- Assessment needs to be repeated frequently (e.g., monitoring post-extubation swallowing recovery)
- The clinical question is specifically about laryngeal function or pharyngeal residue patterns

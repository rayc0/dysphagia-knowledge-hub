---
layout: post
title: "What to Expect from a Videofluoroscopic Swallow Study (VFSS)"
description: "A patient and carer guide to videofluoroscopy (VFSS): preparation, what happens during the test, barium contrast, who is in the room, HK hospital context, and how to read the report."
lang: en
category: equipment
date: 2026-05-13
...
# What to Expect from a Videofluoroscopic Swallow Study (VFSS)
...
## What Is VFSS and Why Is It Done?
...
- Is food or liquid entering the airway (aspiration), and if so, when — before, during, or after the swallow?
- Is the patient aware of the aspiration (coughing), or is it silent?
- Which textures or consistencies are safe, and which require modification?
- Are compensatory strategies — chin tuck, head turn, alternating liquid and solid — effective?
- Is there pharyngeal residue after swallowing, and does it clear with repeat swallows?

## Preparation Before the Appointment

There is usually no special preparation required for a standard VFSS. Patients should:

- Continue regular medications as prescribed (check with the referring clinician)
- Avoid a large meal immediately beforehand — the stomach does not need to be empty, but excessive fullness can cause discomfort
- Inform the radiology team of any known allergy to barium or contrast agents (extremely rare, but important to declare)
- Wear loose, comfortable clothing without metal fastenings over the chest; jewellery should be removed
- Bring the referral letter and any prior swallowing reports
...
- **A radiologist or radiographer** who operates the fluoroscopy equipment and monitors radiation exposure
- **A speech-language therapist** who leads the clinical protocol, presents the food and liquid trials, and interprets swallowing function
- **A nurse** who assists with patient positioning and safety monitoring
- **A dietitian** may attend if there are concurrent nutritional concerns or tube-feeding transition decisions pending
...
## Reading the VFSS Report

The written report from the radiologist and SLT typically addresses:

- **Oral phase**: lip seal, tongue movement, oral transit time, presence of premature spillage
- **Pharyngeal phase**: timing of swallow trigger, laryngeal elevation, epiglottic inversion, presence and timing of aspiration, post-swallow residue sites
- **Oesophageal phase**: if imaged, any hold-up or reflux
- **Recommended diet and fluid levels**: expressed in IDDSI levels (L0–L7)
- **Compensatory strategies**: any manoeuvres shown to reduce aspiration during the study
- **Follow-up recommendations**: repeat study timeline, therapy goals, feeding route advice
...
## When Is VFSS Not the Right Test?

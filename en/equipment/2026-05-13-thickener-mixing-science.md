---
layout: post
title: "The Science of Thickening: Starch vs Xanthan Gum, Amylase Breakdown, and IDDSI Compliance"
description: "Why starch and xanthan gum thickeners behave differently, how salivary amylase thins starch over time, the effect of temperature on viscosity, best practices for consistent IDDSI-compliant thickened drinks."
lang: en
category: equipment
date: 2026-05-13
...
# The Science of Thickening: Starch vs Xanthan Gum, Amylase Breakdown, and IDDSI Compliance
...
**Key properties:**
- Thicken relatively quickly after mixing but continue to thicken for several minutes
- Produce a more opaque, starchy appearance and taste
- Are generally less expensive than xanthan gum products
- Are significantly affected by temperature (see below)
- Are **subject to amylase breakdown** — the most clinically important limitation of starch thickeners
...
**Key properties:**
- Hydrate more slowly than starch (full viscosity develops over 5–10 minutes after mixing)
- Produce a clearer, less flavour-altering result — preferred for preserving drink appearance
- Are stable across a wide temperature range (5–70°C with minimal viscosity change)
- Are **amylase-resistant** — the clinically decisive advantage for patients whose thickened drinks sit in the mouth before swallowing
- Are more expensive than starch-based products

## Amylase Breakdown: Why It Matters
...
- **Starch thickeners** show a marked viscosity reduction as temperature increases. A drink thickened to Level 3 at room temperature (25°C) may drop to Level 2 or lower when served hot at 65°C. This is critical for hot drinks such as Chinese tea (常飲熱茶) and soup.
- **Xanthan gum thickeners** maintain relatively stable viscosity across the 5–70°C temperature range, making them far more reliable for hot beverages.
...
## Concentration Effects and the "Continues-to-Thicken" Problem
...
**Best practice:**
- For starch thickeners: wait 2–3 minutes after mixing before testing and serving
- For xanthan gum thickeners: wait 5–10 minutes after mixing before testing and serving
- Document the waiting time in the care plan or kitchen protocol so all staff use the same preparation method

## Mixing Ratios and Drink Type

The viscosity achieved by a given dose of thickener varies depending on the base liquid:

- **Plain water** is easy to thicken predictably
- **Acidic drinks** (orange juice, lemon water, tomato juice) can interfere with starch thickener performance, reducing viscosity
- **Drinks with natural proteins** (whole milk, soy milk) can interact with xanthan gum, altering the texture
- **Carbonated drinks** present particular challenges for both thickener types
...
1. **Use the correct thickener type** — xanthan gum for patients with delayed swallow initiation; either type for patients with normal initiation
2. **Use the correct dose** for the specific base liquid and IDDSI level
3. **Wait the full hydration time** before testing and serving
4. **Test at service temperature**, not room temperature, for hot drinks
5. **Serve promptly** — do not prepare thickened drinks hours in advance
6. **Verify dose when changing brand** — do not assume that the same number of scoops gives the same result with a different product
7. **Retest after any change** — new patient, new brand, new liquid, new temperature

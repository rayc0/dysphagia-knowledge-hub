...
- **Tube feeding formulas**: Standard enteral formulas typically contain 9–15 mg zinc per 1,000 ml. A patient receiving 1,200–1,500 kcal/day from formula should theoretically meet the RDA of 8–11 mg/day. However, patients with pressure ulcers have substantially elevated zinc requirements (30–40 mg/day), and zinc bioavailability from enteral formula is impaired by concurrent high-dose calcium supplementation, phytate content in fibre-enriched formulas, and increased faecal zinc losses from diarrhoea.
- **Wound losses**: Exudative wounds cause direct zinc losses proportional to exudate volume. Category III–IV pressure ulcers may lose 3–5 mg zinc per day in wound fluid, compounding the nutritional deficit.
- **Medications**: Common medications in elderly dysphagia patients — including ACE inhibitors, thiazide diuretics, and proton pump inhibitors — increase renal zinc excretion or impair absorption.
- **Inflammatory losses**: C-reactive protein-driven hyperzincaemia acutely — serum zinc falls in acute inflammation (redistribution to liver), meaning serum zinc may be falsely low or normal during acute illness and not accurately reflect whole-body stores.
...
- **Zinc sulphate 220 mg tablet**: contains approximately 50 mg elemental zinc. Standard hospital formulary preparation.
- **Zinc gluconate**: contains approximately 14.3 mg elemental zinc per 100 mg — often available in lower-dose OTC preparations
- **Multimicronutrient wound-healing supplements** (e.g., Arginaid, ProSource HP, or similar IDDSI-compatible formulations): contain zinc in combination with arginine, Vitamin C, and Vitamin E — a wound-supportive micronutrient package
...
- Pureed lean red meat (beef, lamb): ~5–7 mg zinc per 100 g cooked, blended with stock to pureed consistency
- Smooth hummus (pureed chickpeas): ~2.5 mg zinc per 100 g
- Pureed oyster (in areas where cultural acceptance exists): 76 mg zinc per 100 g raw — highest dietary source

**IDDSI Level 5 (Minced and Moist):**
- Minced beef/pork in gravy or sauce: 5–7 mg zinc per 100 g
- Soft-cooked lentils (mashed): 1.3 mg zinc per 100 g

**IDDSI Level 6 (Soft and Bite-Sized):**
- Soft-cooked poultry (chicken, turkey thigh): 2–3 mg zinc per 100 g
- Soft tofu (silken): 0.8 mg zinc per 100 g — lower in zinc than meat but culturally accessible in HK
...
- **Copper deficiency anaemia** (hypochromic, microcytic) resistant to iron therapy
- **Myelopathy**: subacute combined spinal cord degeneration (sensory ataxia, weakness) — well-documented with prolonged zinc overdose
- **Neutropenia**: copper deficiency impairs myelopoiesis
...
- Screen for and address nutritional deficiencies in all patients with pressure ulcers
- Provide specialised wound-healing nutrition supplements (including zinc, Vitamin C, arginine) to malnourished patients with Category/Stage II+ pressure injuries
- Serum zinc should be measured in patients with non-healing wounds and supplementation prescribed for documented deficiency
- Caloric and protein targets should be met alongside micronutrient supplementation; micronutrients alone are insufficient without meeting overall energy and protein requirements
...
- European Pressure Ulcer Advisory Panel, National Pressure Injury Advisory Panel, Pan Pacific Pressure Injury Alliance. (2019). *Prevention and Treatment of Pressure Ulcers/Injuries: Clinical Practice Guideline.* Emily Haesler (Ed.). EPUAP/NPIAP/PPPIA.
- Lansdown AB, Mirastschijski U, Stubbs N, et al. (2007). Zinc in wound healing: theoretical, experimental, and clinical aspects. *Wound Repair and Regeneration*, 15(1), 2–16.
- Maret W, Sandstead HH. (2006). Zinc requirements and the risks and benefits of zinc supplementation. *Journal of Trace Elements in Medicine and Biology*, 20(1), 3–18.
- Prasad AS. (2008). Zinc in human health: effect of zinc on immune cells. *Molecular Medicine*, 14(5–6), 353–357.
- Trumbo P, Yates AA, Schlicker S, et al. (2001). Dietary reference intakes: vitamin A, vitamin K, arsenic, boron, chromium, copper, iodine, iron, manganese, molybdenum, nickel, silicon, vanadium, and zinc. *Journal of the American Dietetic Association*, 101(3), 294–301.

...
license: "CC BY 4.0"
canonical: "https://softmeal.org/en/nutrition/meal-frequency-portions-dysphagia.html"
---
...
- **Increased swallowing effort** adds caloric expenditure compared to effortless eating
- **Sarcopenia** (muscle wasting) increases the body's demand for protein and may increase resting metabolic rate in proportion to fat-free mass loss
- **Concurrent conditions** (COPD, heart failure, infection) often increase metabolic demand
- **Activity levels** in bed-bound or chair-bound patients are lower, but the reduction is partially offset by the increased physiological work of compensatory breathing and reduced efficiency
...
- **IDDSI Level 7 (regular) / Level 6 (soft and bite-sized)**: Portions can approach normal size. Focus on soft, moist foods that are high in protein and energy. Avoid dry, crumbly, or hard textures.
- **IDDSI Level 5 (minced and moist)**: Portion size approximately 150–200 g of main food component per meal (e.g., 150 g minced fish in sauce). Enrich with added butter, olive oil, or cream where taste allows.
- **IDDSI Level 4 (puréed)**: Aim for 120–150 g of puréed main protein per sitting. Add maltodextrin powder, cream, or nut butter to increase calorie density without increasing volume.
- **IDDSI Level 3 (liquidised)**: Energy density of liquidised foods is significantly lower. Supplemental enteral nutrition (commercial oral nutritional supplements, ONS) is almost always required at this level to meet total daily targets.
...
*For detailed guidance on protein content of texture-modified foods, see [Protein Fortification for Dysphagia Diets](/en/nutrition/protein-fortification-dysphagia.html). For managing weight loss in dysphagia patients, see [Preventing Malnutrition and Weight Loss in Dysphagia](/en/nutrition/preventing-malnutrition-dysphagia.html).*

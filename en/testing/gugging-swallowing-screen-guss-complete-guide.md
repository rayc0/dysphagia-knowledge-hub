---
title: "Gugging Swallowing Screen (GUSS) — Complete Clinical Guide for Post-Stroke Bedside Dysphagia Screening"
description: "Comprehensive clinical guide to the GUSS bedside dysphagia screen: full 20-point scoring protocol, step-by-step administration, severity categories with diet recommendations, validation evidence, and how it compares to other screens like V-VST and EAT-10."
lang: en
category: testing
date: 2026-05-21
...
- Awake and able to be roused to a sitting (≥60°) upright position for at least 15 minutes
- Able to follow at least one-step instructions
- Not on continuous suctioning for copious secretions
- Not currently intubated (a modified version, GUSS-ICU, exists for post-extubation patients)
...
- A first bolus of **one-third to one-half a teaspoon**
- Followed by **five further half-teaspoons**, if the first is tolerated
...
**Diet:** Texture-modified soft food (IDDSI Levels 5–6), with thin liquids permitted but consumed slowly. Pills may be given crushed in a spoonful of puree.
**Action:** Refer to speech-language pathology for full clinical evaluation. Consider instrumental assessment (FEES or VFSS) within 1–2 weeks if symptoms persist.

### 10–14 points — Moderate dysphagia
**Diet:** Pureed diet (IDDSI Level 4) with thickened fluids only (IDDSI Levels 1–3, depending on what the patient could tolerate). No thin liquids. No solids. Pills must be crushed and mixed with thickened fluid or puree, or given in liquid form.
**Action:** Same-day SLP referral. Instrumental assessment (FEES or VFSS) should be arranged early — within days, not weeks — because the discrepancy between bedside performance and silent aspiration is greatest in this band.
**Nutrition:** If oral intake is likely to be insufficient for >24–48 hours, plan early enteral nutrition (nasogastric tube).

### 0–9 points — Severe dysphagia
**Diet:** NPO. All oral intake — including water and oral medication — withheld.
**Action:** Immediate SLP referral. Instrumental assessment (FEES is usually preferred over VFSS at the bedside for these patients) before any oral trial. Enteral nutrition planning starts immediately; nasogastric tube should be considered if the screen result is unlikely to improve within 24–72 hours.
**Aspiration precautions:** Oral hygiene every 4 hours (the single most effective measure for aspiration pneumonia prevention in NPO patients), head-of-bed elevation, suction at bedside.
...
- Repeat the GUSS daily for the first 72 hours in any patient who scored below 20
- Repeat after any acute clinical change (new chest signs, fever, drowsiness, dysarthria worsening)
- Use the GUSS to *step up* a diet only after instrumental assessment in patients who started in the severe band
...
- **Sensitivity:** 100% in detecting aspiration risk when validated against fiberoptic endoscopic evaluation of swallowing (FEES)
- **Specificity:** ~50% in the original cohort, rising to ~69% in larger replications — the lower specificity is intentional, as the screen is designed to err toward caution
- **Negative predictive value:** Very high — a GUSS of 20 confidently rules out clinically significant aspiration risk
- **Interrater reliability:** Cohen's kappa = 0.835 (excellent agreement between nurses and SLPs)
...
- **GUSS** — Best for *initial* acute screening (especially post-stroke, post-extubation, acute geriatric). Stepwise, safe in unstable patients, gives a defensible NPO-vs-diet decision in 10 minutes.
- **V-VST (Volume-Viscosity Swallow Test)** — Best for *characterising* a known dysphagia. Provides more detail on which viscosity is safe and which fails, and is widely used in outpatient and rehabilitation settings.
- **EAT-10** — A *patient-reported* questionnaire. Best for ambulatory case-finding, not for acute aspiration risk decisions.
...
- Warnecke T, Im S, Kaiser C, et al. Aspiration and dysphagia screening in acute stroke — the Gugging Swallowing Screen revisited. *European Journal of Neurology*. 2017;24(4):594–601.
- Schefold JC, et al. A bedside swallowing screen for the identification of post-extubation dysphagia on the intensive care unit — validation of the Gugging Swallowing Screen (GUSS)–ICU. *Critical Care*. 2023.
- Donau University Krems — Department of Clinical Neurosciences and Preventive Medicine. GUSS Research Project documentation.

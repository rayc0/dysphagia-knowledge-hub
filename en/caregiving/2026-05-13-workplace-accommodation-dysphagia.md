---
layout: post
title: "Returning to Work with Dysphagia: Accommodations and Rights in Hong Kong"
description: "Practical guide to returning to work with dysphagia: Hong Kong Disability Discrimination Ordinance protections, requesting reasonable accommodations, managing meal breaks, communicating with employers, and the link between stress and swallowing."
lang: en
category: caregiving
date: 2026-05-13
...
# Returning to Work with Dysphagia: Accommodations and Rights in Hong Kong
...
## Legal Framework: The Disability Discrimination Ordinance
...
### What counts as a disability under the DDO?

The DDO defines disability broadly. Section 2 includes:
- Physical or mental impairment that affects normal bodily function
- Past, present, or presumed disability
- Conditions affecting a person's capacity to perform ordinary activities
...
- Refuse to hire a person because of their disability
- Dismiss or demote a person because of their disability
- Subject a person with a disability to less favourable terms and conditions
- Deny reasonable accommodation that would allow the person to perform the role
...
- Flexibility in meal break timing and length to allow adequate time for safe eating
- Access to a quiet space for mealtimes (away from social pressure to eat quickly)
- Access to refrigeration and microwave facilities for prepared modified-texture meals
- Permission to bring personal food (rather than relying on a workplace canteen)
- Additional hydration breaks throughout the day
- Time off for SLP appointments and medical reviews without requiring use of annual leave
...
- Complaints handling for discrimination
- Conciliation services between employees and employers
- Free legal advice for qualifying cases
- Education materials for employers about their obligations

EOC contact: 2511 8211 | eoc.org.hk | enquiry@eoc.org.hk
...
## Requesting Accommodations: A Practical Approach
...
### Step 1: Obtain documentation from the clinical team

Before approaching the employer, obtain a letter from the treating speech-language therapist (SLT) or physician that:
- States the diagnosis (dysphagia due to [underlying condition])
- Describes the functional impact on eating and drinking
- Specifies the accommodations recommended (e.g., texture-modified food requirements, additional meal break time, refrigeration access)
- Is written in plain language that a non-clinical HR manager can understand
...
### Step 3: Frame the request constructively
...
- "I need approximately 30 minutes for lunch rather than 20, to eat safely" (rather than "I need a longer lunch break")
- "I need access to the staff kitchen microwave to heat my prepared meals" (rather than "I need special kitchen access")
...
## Managing Meals and Hydration During the Workday
...
Practical guidance:
- **Disclose what is functionally relevant**, not a full medical narrative. "I have a swallowing condition that means I need specific food preparation" is sufficient for most accommodation requests.
- **Identify allies in the workplace** — a trusted manager or HR contact who can facilitate accommodation without requiring the whole team to know.
- **Brief immediate colleagues selectively** if you choose — primarily to avoid awkward situations during team lunches or client entertainment events.
- **Prepare for work-related social eating** — business lunches and team dinners are a normal part of many HK workplaces. Having a script ready reduces anxiety: "I have a swallowing condition — I'll order something that suits me. Please don't let it change anything about the occasion."

## Stress and Swallowing: A Bidirectional Relationship

Stress does not cause dysphagia, but it can worsen swallowing function and the experience of dysphagia in several ways:

- Anxiety heightens pharyngeal and oesophageal sensitivity, increasing the perception of swallowing difficulty
- Stress reduces saliva production, making swallowing harder and increasing the risk of food adherence in the pharynx
- Cognitive load — being busy and stressed — reduces the attentional resources available for compensatory swallowing strategies
- Anxiety about eating in public can trigger a heightened physiological stress response that directly impairs smooth swallowing

Workplace stress management is therefore a legitimate clinical concern for patients with dysphagia. Strategies include:
- Pacing — building adequate time into the workday for mealtimes, not eating on the run
- Mindful eating practices — directing attention to the process of eating rather than multitasking during meals
- Workload management discussions with the treating team if work demands are significantly exacerbating symptoms
- Psychological support (counselling, CBT) if workplace anxiety is a significant driver of swallowing symptom exacerbation

## Resources and Support

- **Equal Opportunities Commission HK**: eoc.org.hk | 2511 8211
- **Labour Department — Employment Rights**: labour.gov.hk
- **HA Medical Social Work**: Request referral through attending team for return-to-work planning support
...
- **HKEX Disability Inclusion Resources** and major HK corporate HR teams increasingly have disability accommodation frameworks — reference these when approaching larger employers
...
1. Disability Discrimination Ordinance, Cap. 487, Hong Kong. legislation.gov.hk.
2. Equal Opportunities Commission. Disability Discrimination: A Practical Guide for Employers. eoc.org.hk.
3. Cichero J, Lam P. Dysphagia: Foundation, Theory and Practice. Wiley-Blackwell, 2011.
4. Nund RL et al. Experiences of dysphagia management following chemoradiotherapy. Int J Lang Commun Disord. 2014.
5. Labour Department HKSAR. Guide to the Employment Ordinance. labour.gov.hk.
6. Threats TT. Use of the ICF in clinical practice for dysphagia. Dysphagia. 2007.

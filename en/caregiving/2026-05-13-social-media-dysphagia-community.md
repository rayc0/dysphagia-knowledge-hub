---
layout: post
title: "Online Dysphagia Community and Social Media: Finding Support and Reliable Information"
description: "How to find reliable online dysphagia information versus misinformation, Hong Kong and international support groups on Facebook, IDDSI community resources, and connecting safely with others who have dysphagia."
lang: en
category: caregiving
date: 2026-05-13
...
- Full framework documentation and testing protocols
- Consumer-facing materials in multiple languages (including Chinese)
- Printable reference guides for caregivers and patients
...
- **Stroke**: Hong Kong Stroke Association (hksa.org.hk), Stroke Foundation (strokefoundation.org.au for English-language resources widely used in HK clinical settings)
- **Parkinson's**: Hong Kong Parkinson's Disease Association (hkpda.org.hk), Parkinson's UK (parkinsons.org.uk)
- **Head and neck cancer**: Hong Kong Cancer Fund (hkcf.org), Cancer Research UK, Memorial Sloan Kettering patient education pages
- **Dementia**: Alzheimer's Disease International (alz.co.uk), Alzheimer's HK (alzhk.org)
...
- **吞嚥障礙支援** (Dysphagia Support) — search variations of this term for HK-based Chinese language groups; group size and activity vary
- **中風康復支援 香港** — Stroke recovery support groups, which frequently include dysphagia discussions
- **柏金遜症患者及照顧者** — Parkinson's patient and caregiver groups where dysphagia management is regularly discussed
- **香港頭頸癌患者組** — Head and neck cancer patient groups with significant dysphagia-relevant content
- **香港照顧者** (Hong Kong Caregiver) — general caregiver support groups with members managing dysphagia in care recipients
...
- **Hong Kong Cancer Fund** (hkcf.org) — online community forum and social media channels; active Chinese and English content
- **Hong Kong Stroke Association** — Facebook page with regular updates and community engagement
- **Hong Kong Parkinson's Disease Association** — WeChat group and Facebook presence; active caregiver community
...
- Emotional support and normalisation — finding others who understand
- Practical exchange — recipes, product reviews, care home tips
- Logistical help — which restaurants in HK can accommodate IDDSI requirements, where to buy specific thickeners
- Advocating together — sharing experiences to improve services and policy

They are at their worst when used for:
- Self-diagnosis or modification of clinical prescriptions (texture levels, thickener concentrations)
- Replacing clinical assessment with crowdsourced opinion
- Seeking validation for unsafe practices ("is it okay if I give Grandma thin liquids? She hates the thickener")
...
- Even "closed" Facebook groups may have thousands of members and no effective privacy guarantee
- Screenshots are easily taken and shared beyond the original group
- Medical details shared online may affect insurance applications, employment, and other matters
- Children's information should never be shared in ways that allow identification

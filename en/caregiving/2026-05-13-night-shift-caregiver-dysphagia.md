...
license: "CC BY 4.0"
canonical: "https://softmeal.org/en/caregiving/night-shift-caregiver-dysphagia.html"
---
...
- Adjustable profiling beds (electric or manual) are the most reliable option. These can be rented or purchased from medical equipment suppliers such as Medline HK, Lifeline Medical, or through the Hospital Authority's occupational therapy (OT) equipment loan scheme (ask the ward OT before discharge).
- Bed wedges — foam wedges placed under the mattress from the shoulder upward — achieve a consistent 30-degree elevation without requiring an adjustable frame. They are available online and from medical supply shops.
- Avoid stacking multiple pillows under the head alone. If pillows are the only available option, place them under the upper back and shoulders as well.
...
- **Do not position the patient in full supine (completely flat) overnight** unless there is a specific clinical reason (e.g., orthopaedic restriction). Full supine is the highest-aspiration-risk sleeping position for dysphagia patients.
- **Do not use chin-tuck positioning for sleep.** Chin tuck (forward head flexion) is a mealtime swallowing compensation, not a sleeping position. Sustained neck flexion overnight causes pain and can restrict the airway.
- **Ensure the patient can move.** Restraint (physical or chemical) that prevents repositioning increases pressure injury risk without necessarily reducing aspiration risk. The goal is to provide a starting position that defaults to elevation, not to fix the patient immovably.
...
- **Wet or gurgling breathing sounds** — indicates secretions in the upper airway or pharynx. Not always pathological but warrants position check and, if persistent, medical review.
- **Increased coughing during the night** — episodic coughing without obvious cause can represent nocturnal aspiration or reflux events.
- **Morning hoarseness** — persistent hoarse voice upon waking, beyond the normal few minutes, may indicate laryngeal irritation from aspiration or reflux.
- **Fever developing overnight** — low-grade fever (37.5–38°C) by morning following a previously well evening can be an early sign of aspiration pneumonia.
- **Increased secretion volume at morning oral care** — more than usual pooled saliva or altered secretion character (thicker, discoloured) can reflect overnight respiratory changes.
- **Desaturation (if pulse oximeter is in use)** — a drop in SpO2 below 94% during overnight monitoring is a significant finding. Overnight pulse oximetry monitoring for at-risk patients is available through HA respiratory and palliative care teams.
...
- Respiratory distress: laboured breathing, use of accessory muscles (neck, shoulder muscles visibly working), nasal flaring
- Cyanosis (bluish tinge to lips or fingertips)
- Unresponsiveness or altered consciousness
- Severe persistent choking that does not resolve with positioning, back blows, and abdominal thrusts

### Seek urgent medical attention within hours (A&E or urgent GP) if:

- Temperature above 38.5°C with new or worsening cough
- Productive cough with coloured (yellow, green, brown) sputum that is new in onset
- Oxygen saturation consistently below 94% on home pulse oximeter
- Sudden marked decrease in ability to swallow, including inability to manage usual IDDSI level

### Monitor and report at next clinical review if:

- New morning hoarseness lasting more than 30 minutes that resolves during the day
- Intermittent mild nocturnal coughing without fever or sputum change
- New onset of nocturnal reflux symptoms (heartburn, acid regurgitation) — discuss with GP, may need GERD management
...
- [ ] Complete oral care at 30–45 degrees, wait 30 minutes, then position for sleep
- [ ] Head of bed elevated 30–45 degrees (whole torso, not just head)
- [ ] Dentures removed and soaking in solution
- [ ] Last oral/NG feed completed at least 2 hours before lying flat (if applicable)
- [ ] Suction device within reach (if prescribed)
- [ ] Emergency numbers visible: 999 (ambulance) and patient's SLT/community nurse contact

---

*For oral hygiene technique in detail, see [Oral Hygiene for Dysphagia Patients: Reducing Aspiration Pneumonia Risk](/en/caregiving/oral-hygiene-dysphagia.html). For recognising aspiration pneumonia, see [Aspiration Pneumonia: Signs, Prevention, and When to Go to A&E](/en/caregiving/aspiration-pneumonia-signs-prevention.html).*

...
license: "CC BY 4.0"
canonical: "https://softmeal.org/en/caregiving/respite-care-options-hk.html"
---
...
1. **Assessment**: A Social Security Field Unit (SSFU) social worker or a medical social worker (MSW) at the patient's hospital or GOPC conducts a functional assessment using the standardised tool (currently the Case Management Assessment tool).
2. **Registration on CIWAS**: The patient is registered with their assessed care needs level. Eligibility and priority are based on this assessment.
3. **Waiting list**: As of 2025, waiting times for subsidised community care services vary by district, but 12–24 months is not unusual. Self-financing (fee-paying) places at the same centres are often available immediately at higher cost.
4. **Interim options**: While waiting, some NGOs offer short-term or drop-in attendance with fee-based payment. Ask the MSW about interim options in your district.
...
*For carer support groups and emotional wellbeing resources, see [Carer Wellbeing and Burnout Prevention](/en/caregiving/carer-wellbeing-burnout-prevention.html). For understanding the patient's IDDSI prescription, see [Understanding Your IDDSI Prescription: A Caregiver Guide](/en/caregiving/understanding-iddsi-prescription-carer-guide.html).*

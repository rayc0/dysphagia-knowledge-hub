---
layout: post
title: "Returning to Work with Dysphagia: Practical Advice and Legal Rights"
lang: en
category: caregiving
tags:
  - dysphagia
...
- Is my swallowing stable enough to manage mealtimes at work independently, or do I need supervision?
- Are there specific foods or drinks I must avoid that I need to plan around in a workplace setting?
- Is my fatigue level compatible with full-time work, or should I consider a phased return?
- Do I need any scheduled appointments or therapy that will require time off?
...
**What to consider:**
- Dysphagia is generally not visible unless you are eating or drinking. If your role does not involve food-related duties, you may choose minimal disclosure.
- If you need adjustments — a quieter space to eat, modified food at company events, or time off for therapy — you will need to request them, which requires some level of disclosure.
- A practical middle ground: disclose to HR or occupational health in confidence, without necessarily informing your entire team. Reasonable accommodation requests are processed through these channels.
...
**Mealtime planning:**
- Request a quiet space to eat your meal away from the open-plan office. Eating without the pressure of conversation reduces swallowing errors.
- If the company provides lunch, speak to HR or facilities about having a suitable option prepared, or bring your own meals in a thermal container.
- Allow yourself adequate time for lunch. Rushed eating is unsafe with dysphagia. If your workplace culture discourages full lunch breaks, address this with your manager.

**Hydration:**
- If you use thickened fluids, keep your thickener and a suitable bottle at your desk. This is no different from any other medication-adjacent management routine.
- If you are in client-facing meetings, a travel cup with a lid is unobtrusive and functional.

**Meeting and event management:**
- Catered meetings and team lunches require advance communication. A brief note to the organiser — "I have dietary requirements due to a medical condition, could you include [specific texture] options?" — is standard professional courtesy.
- You are not required to explain further than "dietary requirements" unless you choose to.

**Fatigue management:**
- Swallowing-related fatigue is real. If you are returning after a significant illness, discuss a phased return (starting with reduced hours) with your employer.
- Short breaks during the day and protecting your lunch hour as genuine rest time both reduce cumulative fatigue.

## When the Work Environment Is Not Adjustable

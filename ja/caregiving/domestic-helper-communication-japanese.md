...
license: "CC BY 4.0"
canonical: "https://softmeal.org/ja/caregiving/domestic-helper-communication-japanese.html"
---
...
- **写真入り手順書**（文字が読めなくても理解できる）
- **IDDSI食形態カラーカード**（公式サイトから無料ダウンロード可：www.iddsi.org）
- **本記事の多言語コミュニケーション表**（以下参照）
- **処方書のコピー**（言語治療師が作成した食形態・液体レベルの処方書）
...
- このカップの水にとろみをつけてみてください
- 患者が食事中にむせたら何をしますか？
- 食後どのくらい座ったままにしておきますか？
...
**原因：** 計量スプーンを使わずに目分量で調製している
**解決策：** 専用の計量スプーンを準備し、必ずスプーンで計測するよう指導。増粘剤缶にテープでスプーンを貼り付けておく。

### 問題2：食後すぐに横にしてしまう

**原因：** 食後の体位保持の重要性を理解していない
**解決策：** タイマーをキッチンに設置し、食後30分のアラームを設定。「横にする前にタイマーを鳴らす」ことをルール化。

### 問題3：急いで食べさせる

**原因：** 他の家事を早く済ませたい
**解決策：** 食事介助の時間（通常20〜40分）をスケジュールに明示的に確保する。食事介助中は他の家事をしないことをルール化。

### 問題4：緊急時にパニックになる

**原因：** 緊急対応の練習不足
**解決策：** 四半期ごとにむせ・誤嚥の緊急対応ロールプレイを実施。緊急連絡先（999・家族の携帯番号）を食卓の近くに大きく貼る。
...
- FDHの雇用主は、FDHが医療ケアを行う場合の適切な研修と指導に責任を負います
- 言語治療師による家庭訪問指導サービス（Private Practice ST）を活用することで、FDHへの直接指導が可能です
- 社会福祉署の「安老院及護養院」プログラムでは、FDHを含む介護者への嚥下障害ケア研修が無料または低料金で提供されています

...
**最終更新日：** 2026-04-19 · **ライセンス：** [CC BY 4.0](../../LICENSE) · **編集：[SeniorDeli (Carewells)](https://www.seniordeli.com)** — 香港を拠点とするソーシャルエンタープライズ。IDDSI 準拠の嚥下調整食を製造し、嚥下障害のある方の食の質の向上に取り組んでいます。本ページは教育目的のみです。詳細は [About](/about) をご覧ください。
